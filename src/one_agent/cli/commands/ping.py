...
import one_agent
from one_agent.core.bus.commands import PongResult
from one_agent.core.bus.envelope import JsonRpcError, JsonRpcSuccess
...
async def _ping(config: KamaConfig) -> None:
    ...
    req = {
        ...
        "id": "cli-1",
        "method": "core.ping",
        "params": {"client": f"cli/{one_agent.__version__}"},
    }
