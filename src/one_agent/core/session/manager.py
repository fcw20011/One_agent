...
from one_agent.core.bus.envelope import HandlerError
from one_agent.core.bus.events import (
    SessionClosedEvent,
    SessionCreatedEvent,
...
from one_agent.core.session.model import Session, SessionMode
from one_agent.core.session.store import SessionStore
from one_agent.core.skills.loader import SkillLoader
...
class SessionManager:
    ...
    async def compact(self, sid: str, focus: str = "") -> Any:
        ...
        async with lock:
            from one_agent.core.bus.commands import SessionCompactResult
