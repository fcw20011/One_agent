...
import one_agent
from one_agent.core.bus.commands import (
    AgentRunCommand,
    AgentRunResult,
...
from one_agent.core.bus.envelope import EventPushEnvelope
from one_agent.core.config import KamaConfig, get_config
from one_agent.core.events.bus import EventBus
from one_agent.core.llm.provider import AnthropicProvider
from one_agent.core.logging_setup import setup_logging
from one_agent.core.mcp.server import McpServerManager
from one_agent.core.permissions.manager import PermissionManager
from one_agent.core.permissions.storage import load_policy_file
from one_agent.core.runner import AgentRunner
from one_agent.core.runs import events_file, new_run_id
from one_agent.core.session import SessionManager, SessionStore
from one_agent.core.trace.record import TraceRecord
from one_agent.core.trace.writer import TraceWriter
from one_agent.core.transport.ipc_broadcaster import IpcEventBroadcaster
from one_agent.core.transport.socket_server import SocketServer, get_connection_writer
...
class CoreApp:
    ...
    async def _ping_handler(self, params: dict[str, Any]) -> PongResult:
        ...
        return PongResult(
            server_version=one_agent.__version__,
    ...
    async def run(self) -> None:
        ...
        logger.info("kama-core %s listening addr=%s", one_agent.__version__, addr)
