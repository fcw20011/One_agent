...
from one_agent.core.agents.loader import AgentProfile, AgentProfileLoader
from one_agent.core.bus.events import SubagentFinishedEvent, SubagentStartedEvent
from one_agent.core.context import ExecutionContext
from one_agent.core.events.bus import EventBus
from one_agent.core.events.writer import EventWriter
from one_agent.core.loop import AgentLoop
from one_agent.core.runs import new_run_id
from one_agent.core.subagent.registry import BackgroundTaskRegistry
from one_agent.core.tools.base import BaseTool, ToolResult
from one_agent.core.tools.builtin.bash import BashTool
from one_agent.core.tools.builtin.list_dir import ListDirTool
from one_agent.core.tools.builtin.read_file import ReadFileTool
from one_agent.core.tools.builtin.task_create import TaskCreateTool
from one_agent.core.tools.builtin.task_get import TaskGetTool
from one_agent.core.tools.builtin.task_list import TaskListTool
from one_agent.core.tools.builtin.task_update import TaskUpdateTool
from one_agent.core.tools.builtin.write_file import WriteFileTool
from one_agent.core.tools.registry import ToolRegistry

if TYPE_CHECKING:
    from one_agent.core.llm.base import LLMProvider
...
class SpawnAgentTool(BaseTool):
    ...
    def _build_child_registry(
        ...
        from one_agent.core.task.manager import TaskManager
